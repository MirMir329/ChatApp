...
const Chat = () => {
    ...
    const { chatId, user, isCurrentUserBlocked, isReceiverBlocked, changeShowInfo, setModalImageInfo, changeShowModalRecording } = useChatStore()
        ...
        <div className="chat">
            ...
            <div className="bottom">
                <div className="icons">
                    ...
                    <img src="./mic.png" alt="" onClick={changeShowModalRecording}/>
                </div>
